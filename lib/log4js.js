 ...
 * @param  {Boolean} [logToConsole=true] Optional param to stop logging to the console.
 * @return {Logger} instance of logger for the category
 * @static
 */
function getLogger (categoryName, logToConsole) {
    if (typeof logToConsole !== 'boolean') {
        logToConsole = false;
    }
    consoleOutputFlag = logToConsole;
...
function LoggingEvent(categoryName, level, data, logger) {
    ...
    this.level = level;
    this.logger = logger;
    this.consoleOutputFlag = consoleOutputFlag;
}
...
function setConsoleLogging(consoleOutput) {
    consoleOutputFlag = consoleOutput ? consoleOutput : true;
}
