...
function useCallStack(bool = true) {
  gCallStackEnabled = (bool === true);

  loggers.forEach(logger => logger.enableCallStack(gCallStackEnabled));
...
function getLogger(category) {
  ...
  if (!logger) {
    logger = (new Logger(category)).enableCallStack(
      categories.isCallStackEnable(category) || gCallStackEnabled
    );
