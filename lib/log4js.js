...
function configure(configurationFileOrObject) {
  ...
  var config = validateAndParse(configurationFileOrObject);
...
function validateAndParse(configurationFileOrObject) {
    var filename, config = process.env.LOG4JS_CONFIG || configurationFileOrObject;

    checkThatConfigIsStringOrObject(config);
...
function checkThatConfigIsStringOrObject(config) {
