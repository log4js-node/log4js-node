 ...
 */
function gelfAppender (layout, host, port, hostname, facility, customFields) {
...
function configure(config) {
  ...
  return gelfAppender(layout, config.host, config.port, config.hostname, config.facility, config.customFields);
}
